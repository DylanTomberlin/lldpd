    ...
    @pytest.mark.parametrize("command, expected", [
        ...
        ("pd powerpairs signal class class-4 typeat 2 source pse priority low requested 60000 "
         ...
         ("pse powerpairs spare class class-4 typeat 2 "
          "priority low source backup requested 0 "
          "allocated 0 typebt pse4 pseStatus dual4pair "
          "pairsExt both aClass class-5 bClass class-4 "
          "classExt dual pseMaxPower 80000 "
          "autoclassSupport aRequested 10000 bRequested "
          "20000 aAllocated 30000 bAllocated 40000",
         {'supported': 'no',
          'enabled': 'no',
          'paircontrol': 'no',
          'device-type': 'PSE',
          ...
          'requested': '0',
          'allocated': '0',
          'pid4': '4PID is not supported by PD',
          'aRequested': '10000',
          'bRequested': '20000',
          'aAllocated': '30000',
          'bAllocated': '40000',
          'pseStatus': '4-pair powering dual-signature PD',
          'pdStatus': 'unknown',
          'pairsExt': 'Both Alternatives',
          'aClass': 'Class 5',
          'bClass': 'Class 4',
          'classExt': 'Dual-signature PD',
          'typebt': 'Type 4 PSE',
